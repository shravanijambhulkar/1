...
// -----
  ...
  var dong1 = createSprite(100,130,30,10);
  dong1.shapeColor = "red";
  var dong2 = createSprite(215,130,30,10);
  dong2.shapeColor = "red";
  var dong3 = createSprite(165,250,30,10);
  dong3.shapeColor = "red";
  var dong4 = createSprite(270,250,30,10);
 ...
 var count= 0;
  if(ding.isTouching(dong1) || ding.isTouching(dong2)) 
